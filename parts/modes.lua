return {
    ...
    {name='dig_10l',       x=-200,      y=-200,     size=40,shape=1,icon="dig_sprint",  unlock={'dig_40l','dig_eff_10l', "dig_eff_10l_123"}},
    ...
    {name='dig_eff_10l_123',x=-200,     y=0,        size=40,shape=1,icon="dig_sprint"},
    ...
    {name='master_n',      x=0,         y=-1000,    size=40,shape=1,icon="master",      unlock={'master_h','strategy_h', 'master_death'}},
    {name='master_death',  x=120,       y=-1150,    size=40,shape=1,icon="master",      unlock={'master_phantom'}},
    {name='master_phantom',x=230,       y=-1180,    size=40,shape=1,icon="master"},
    ...
    {name='blind_e',       x=350,       y=-700,     size=40,shape=1,icon="hidden",      unlock={'blind_n','master_instinct'}},
    {name='blind_n',       x=350,       y=-800,     size=40,shape=1,icon="hidden",      unlock={'blind_h'}},
    {name='blind_h',       x=350,       y=-900,     size=35,shape=1,icon="hidden",      unlock={'blind_l'}},
    {name='blind_l',       x=350,       y=-1000,    size=35,shape=3,icon="hidden2",     unlock={'blind_u'}},
    {name='blind_u',       x=350,       y=-1100,    size=30,shape=3,icon="hidden2",     unlock={'blind_wtf'}},
    {name='blind_wtf',     x=350,       y=-1200,    size=25,shape=2,icon="hidden2"},
    {name='master_instinct',x=485,      y=-835,     size=40,shape=3,icon="hidden"},
    ...
    {name='survivor_e',    x=650,       y=-600,     size=40,shape=1,icon="survivor",    unlock={'survivor_n'}},
    {name='survivor_n',    x=850,       y=-600,     size=40,shape=1,icon="survivor",    unlock={'survivor_h','attacker_h','defender_n','dig_h'}},
    {name='survivor_h',    x=1050,       y=-600,     size=40,shape=1,icon="survivor",    unlock={'survivor_l'}},
    {name='survivor_l',    x=1250,      y=-600,     size=40,shape=3,icon="survivor",    unlock={'survivor_u'}},
    {name='survivor_u',    x=1450,      y=-600,     size=40,shape=2,icon="survivor"},

    {name='attacker_h',    x=650,       y=-800,     size=40,shape=1,icon="attack",      unlock={'attacker_u'}},
    {name='attacker_u',    x=650,       y=-1000,    size=40,shape=1,icon="attack"},

    {name='defender_n',    x=850,       y=-800,     size=40,shape=1,icon="defend",      unlock={'defender_l'}},
    {name='defender_l',    x=850,       y=-1000,    size=40,shape=1,icon="defend"},

    {name='dig_h',         x=1050,       y=-800,     size=40,shape=1,icon="dig",         unlock={'dig_u'}},
    {name='dig_u',         x=1050,       y=-1000,    size=40,shape=1,icon="dig"},
